...
<div class="container-fluid text-center">
  <div class="row">
    ...
    <div class="col-sm-5" style={{background:'#ffffff',padding:'85px',lineHeight:'1.7em',paddingTop:'5%',height:'100vh',textAlign:'left'}}>
...
<div className="d-flex flex-row mb-3" style={{marginTop:'50px'}}>
        ...
        <div style={{color:'#576871',fontSize:'14px',textAlign:'center',borderRight:'1px solid #ccc',padding:'10px'}}>Test Duration
        <p style={{color:'#333333',fontSize:'20px',textAlign:'center',fontWeight:'bold',paddingTop:'10px'}}>{localStorage.getItem('ttime') || ttime } mins</p>
        </div>
    ...
    <div class="col-sm-7" style={{borderLeft:'1px solid #ccc',background:'#f3f7f7',padding:'85px',lineHeight:'1.7em',paddingTop:'5%',height:'100vh'}}>
...
<div style={{textAlign:'left'}}>
       ...
       <strong> <h6>Rules and Guidelines:</h6></strong>
        ...
        <div className="text-center" style={{marginTop:'20px'}}><a href="/usertest" class="btn btn-primary">Proceed With Test</a></div>
    </div>
  </div>
</div>
